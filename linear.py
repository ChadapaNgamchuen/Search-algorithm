...
# Create a window
window = pyglet.window.Window(width=800, height=350, caption='Linear Search Visualization')
batch = pyglet.graphics.Batch()

# Generate a list with random numbers ensuring 88 is included
numbers = random.sample(range(1, 200), 19) + [88]
